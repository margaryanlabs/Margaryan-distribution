...
export async function POST(req:Request){
  ...
  try{
    ...
    const report=await runAutopilot({missionId:typeof body.missionId==="string"?body.missionId:undefined,leadTarget:Number(body.leadTarget||25),researchPerTick:Number(body.researchPerTick||10),outreachPerTick:Number(body.outreachPerTick||5),smmDays:Number(body.smmDays||7),pollInbox:body.pollInbox!==false,runActions:body.runActions!==false});
